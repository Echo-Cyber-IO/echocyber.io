    ...
    <section class="relative pt-16 pb-4 lg:pt-20 lg:pb-6 overflow-hidden">
        ...
        <div class="relative mx-auto max-w-3xl px-6 text-center lg:px-8">
            <div class="flex items-center justify-center gap-3">
                ...
                <span class="font-mono text-xs uppercase tracking-widest text-crimson-450">Free 30-minute call</span>
                <div class="w-8 h-1 bg-crimson-600 rounded-full"></div>
            </div>
    ...
    <section class="pt-0 pb-16 lg:pb-24">
        <div class="mx-auto max-w-7xl px-4">
            ...
            <p class="mt-8 text-center text-sm text-echo-400">
                ...
                <a href="/contact" class="font-semibold text-crimson-500 transition-colors hover:text-crimson-450">Send a message instead</a>.
            </p>
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-12">
                <div class="lg:col-span-5">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-1 bg-crimson-600 rounded-full"></div>
                        <span class="font-mono text-xs uppercase tracking-widest text-crimson-450">FAQ</span>
                    </div>
                    ...
                    <p class="mt-6 text-echo-400">
                        ...
                        <a href="/contact" class="font-semibold text-crimson-500 hover:text-crimson-450 transition-colors">Get in touch</a>.
                    </p>
                </div>
