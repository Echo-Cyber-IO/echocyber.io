...
<section id="services" class="py-20 lg:py-28 bg-stone-100">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-16">
            {{-- Block 1 --}}
            <div class="group relative bg-white shadow-md border border-stone-200 rounded-xl p-8 hover:border-crimson-500/50 transition-all duration-500 hover:bg-stone-100">
                ...
                <div class="relative">
                    <div class="inline-flex items-center justify-center w-10 h-10 bg-crimson-50 rounded-lg mb-5">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                <div class="flex items-start gap-3 bg-stone-100 border border-stone-200 rounded-lg p-4 hover:border-crimson-500/50 transition-colors">
                    <span class="text-crimson-500 mt-0.5 flex-shrink-0">&#x25B8;</span>
            ...
            <div class="mt-10 max-w-2xl mx-auto">
                <div class="border-l-4 border-crimson-600 pl-6 py-2">
...
<section id="about" class="py-20 lg:py-28 bg-stone-100">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div class="space-y-6">
                <div class="bg-white shadow-md border border-stone-200 rounded-xl p-8 relative overflow-hidden">
                    <div class="absolute top-0 left-0 w-1 h-full bg-crimson-600"></div>
                    <svg class="h-8 w-8 text-crimson-500/30 mb-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-white shadow-md border border-stone-200 rounded-xl p-8 relative overflow-hidden">
                ...
                <p class="text-stone-600 leading-relaxed mb-6">Mike has an exceptional talent for building authentic, trust-based relationships with customers. He was a key contributor to both strategic direction and client engagement. His skill set brings immediate value and would be an asset to any organization.</p>
                <div class="border-t border-stone-200 pt-4">
                    <p class="text-stone-950 font-semibold text-sm">James L. Jackson, MBA, CISM</p>
                    <p class="text-stone-500 text-sm">Cybersecurity Leader</p>
                </div>
            </div>
            ...
            <div class="bg-white shadow-md border border-stone-200 rounded-xl p-8 relative overflow-hidden">
                ...
                <p class="text-stone-600 leading-relaxed mb-6">Mike has the ability to communicate technical concepts to a non-technical audience. When assigned a task, you can trust it will be done with the same level of attention to detail as if you had done it yourself.</p>
                <div class="border-t border-stone-200 pt-4">
                    <p class="text-stone-950 font-semibold text-sm">JD Helms</p>
                    <p class="text-stone-500 text-sm">COO @ SoftwareOne · Co-Founder @ PsychReport.ai</p>
                </div>
            </div>
            ...
            <div class="bg-white shadow-md border border-stone-200 rounded-xl p-8 relative overflow-hidden">
                ...
                <p class="text-stone-600 leading-relaxed mb-6">Mike is a strategic leader with deep expertise across multiple technology areas. He knows how to build trusted relationships with his customers, vendors, senior managers, peers, and direct reports. He is one of the good guys.</p>
                <div class="border-t border-stone-200 pt-4">
                    <p class="text-stone-950 font-semibold text-sm">Karan Sorensen, Ed.D, MBA, MS</p>
                    <p class="text-stone-500 text-sm">Innovation & Technology Executive</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-16 lg:py-20 bg-stone-100">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-8">
            {{-- Retailer --}}
            <div class="group bg-white shadow-md border border-stone-200 rounded-xl p-8 hover:border-crimson-500/50 transition-all duration-500 hover:bg-stone-50">
                <div class="flex items-center gap-3 mb-4">
                    <span class="text-crimson-500 font-display font-bold text-lg">01</span>
                    <div>
...
<section id="pricing" class="py-20 lg:py-28 bg-stone-100">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-6 mb-10">
            {{-- Tune --}}
            <div class="group bg-white shadow-md border border-stone-200 hover:border-crimson-500 rounded-xl p-8 transition-all duration-300 hover:bg-stone-50 flex flex-col">
                <div class="text-center mb-6">
                    <div class="inline-flex items-center justify-center w-16 h-16 bg-crimson-50 group-hover:bg-crimson-100 rounded-2xl mb-5 transition-colors">
            ...
            {{-- Signal (highlighted) --}}
            <div class="group bg-white shadow-lg border-2 border-crimson-500 rounded-xl p-8 transition-all duration-300 hover:bg-stone-50 hover:border-crimson-500/40 flex flex-col relative">
                <div class="absolute -top-3 left-1/2 -translate-x-1/2">
                    <span class="bg-crimson-700 text-white text-xs font-semibold px-3 py-1 rounded-full uppercase tracking-wider">Most Popular</span>
                </div>
                <div class="text-center mb-6">
                    <div class="inline-flex items-center justify-center w-16 h-16 bg-crimson-100 group-hover:bg-crimson-200 rounded-2xl mb-5 transition-colors">
                        <svg class="h-8 w-8 text-crimson-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <p class="text-crimson-500 text-lg font-semibold mb-1">$10,000/mo</p>
        ...
        {{-- Below tiers note --}}
        <p class="text-center text-stone-500 text-sm max-w-xl mx-auto">
