        ...
        <div class="flex flex-col items-center gap-8">
            ...
            <div class="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
                <div class="flex items-center">
                    <img src="/assets/img/clients/bose.png" alt="Bose" class="h-12 w-auto">
                </div>
                <div class="flex items-center">
                    <img src="/assets/img/clients/strongrock.png" alt="Strongrock Engineering Group" class="h-12 w-auto">
                </div>
                <div class="flex items-center">
