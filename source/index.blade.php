...
<section class="bg-echo-950 py-24 sm:py-32">
    <div class="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <div class="flex items-center justify-center gap-3">
            ...
            <span class="font-mono text-xs uppercase tracking-widest text-crimson-500">What I actually do</span>
            <div class="w-8 h-1 bg-crimson-600 rounded-full"></div>
        </div>
        <p class="mx-auto mt-6 max-w-2xl text-center font-display text-4xl font-bold tracking-tight text-balance text-white sm:text-5xl">
        ...
        <div class="mt-12 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div class="relative lg:row-span-2">
                <div class="absolute inset-px rounded-lg bg-echo-900 lg:rounded-l-[2rem]"></div>
                <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(0.5rem+1px)] lg:rounded-l-[calc(2rem+1px)]">
                    <div class="px-8 pt-8 pb-3 sm:px-10 sm:pt-10">
                        <p class="text-sm font-mono uppercase tracking-widest text-crimson-500 max-lg:text-center">In the room</p>
                        <p class="mt-3 font-display text-2xl font-semibold tracking-tight text-white max-lg:text-center">When it actually matters.</p>
                        ...
                        <div class="w-full max-w-sm rounded-xl bg-echo-950/80 p-5 ring-1 ring-echo-700/40 shadow-2xl shadow-crimson-950/50">
                            ...
                            <ul class="mt-4 space-y-3 text-sm">
                                <li class="flex items-start gap-3">
                                    <span class="mt-1 h-2 w-2 flex-none rounded-full bg-crimson-500"></span>
                                    <div class="flex-1">
                                        <p class="text-white">Board security update</p>
                                        <p class="text-xs text-echo-500">Translating last quarter's incidents</p>
                                    </div>
                                </li>
                                <li class="flex items-start gap-3">
                                    <span class="mt-1 h-2 w-2 flex-none rounded-full bg-echo-600"></span>
                                    <div class="flex-1">
                                        <p class="text-echo-300">Vendor SOC 2 review</p>
                                        <p class="text-xs text-echo-500">Should we trust their controls?</p>
                                    </div>
                                </li>
                                <li class="flex items-start gap-3">
                                    <span class="mt-1 h-2 w-2 flex-none rounded-full bg-echo-600"></span>
                                    <div class="flex-1">
                                        <p class="text-echo-300">Cyber insurance renewal</p>
                                        <p class="text-xs text-echo-500">3-page questionnaire, 47 questions</p>
                                    </div>
                                </li>
                                <li class="flex items-start gap-3">
                                    <span class="mt-1 h-2 w-2 flex-none rounded-full bg-echo-600"></span>
                                    <div class="flex-1">
                                        <p class="text-echo-300">Tabletop exercise prep</p>
                                        <p class="text-xs text-echo-500">"What do we do if..."</p>
                                    </div>
                                </li>
                                <li class="flex items-start gap-3">
                                    <span class="mt-1 h-2 w-2 flex-none rounded-full bg-echo-600"></span>
                                    <div class="flex-1">
                                        <p class="text-echo-300">CFO 1:1</p>
                                        <p class="text-xs text-echo-500">Why the security spend is going up</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="pointer-events-none absolute inset-px rounded-lg outline outline-echo-700/40 lg:rounded-l-[2rem]"></div>
            </div>

            {{-- Cell 2: Translation (top middle) --}}
            <div class="relative max-lg:row-start-1">
                <div class="absolute inset-px rounded-lg bg-echo-900 max-lg:rounded-t-[2rem]"></div>
                <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(0.5rem+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                    <div class="px-8 pt-8 sm:px-10 sm:pt-10">
                        <p class="text-sm font-mono uppercase tracking-widest text-crimson-500 max-lg:text-center">Translation</p>
                        <p class="mt-3 font-display text-2xl font-semibold tracking-tight text-white max-lg:text-center">Both directions.</p>
                        <p class="mt-3 max-w-lg text-sm/6 text-echo-400 max-lg:text-center">Boardroom ↔ server room. Without it, your team translates badly and your board approves the wrong thing.</p>
                    </div>
                    {{-- Translation comparison --}}
                    <div class="flex-1 flex items-center px-8 pb-8 sm:px-10 sm:pb-10">
                        <div class="w-full space-y-3">
                            <div class="rounded-lg bg-echo-950/60 p-3 ring-1 ring-echo-700/40">
                                <p class="text-xs font-mono text-echo-500">VENDOR SAID</p>
                                <p class="mt-1 text-sm text-echo-300">"You need EDR with XDR integration and SOAR for full SOC visibility."</p>
                            </div>
                            <div class="flex justify-center">
                                <svg class="h-5 w-5 text-crimson-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"/></svg>
                            </div>
                            <div class="rounded-lg bg-crimson-950/40 p-3 ring-1 ring-crimson-700/30">
                                <p class="text-xs font-mono text-crimson-400">WHAT IT MEANS</p>
                                <p class="mt-1 text-sm text-white">"Better laptop protection that talks to your other tools — so you see attacks faster."</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="pointer-events-none absolute inset-px rounded-lg outline outline-echo-700/40 max-lg:rounded-t-[2rem]"></div>
            </div>

            {{-- Cell 3: Frameworks (middle bottom) --}}
            <div class="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
                <div class="absolute inset-px rounded-lg bg-echo-900"></div>
                <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(0.5rem+1px)]">
                    <div class="px-8 pt-8 sm:px-10 sm:pt-10">
                        <p class="text-sm font-mono uppercase tracking-widest text-crimson-500 max-lg:text-center">Frameworks</p>
                ...
                <div class="pointer-events-none absolute inset-px rounded-lg outline outline-echo-700/40"></div>
            </div>

            {{-- Cell 4: Built for founders (tall right) --}}
            <div class="relative lg:row-span-2">
                <div class="absolute inset-px rounded-lg bg-echo-900 max-lg:rounded-b-[2rem] lg:rounded-r-[2rem]"></div>
                <div class="relative flex h-full flex-col overflow-hidden rounded-[calc(0.5rem+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                    <div class="px-8 pt-8 pb-3 sm:px-10 sm:pt-10">
                        <p class="text-sm font-mono uppercase tracking-widest text-crimson-500 max-lg:text-center">Built for founders</p>
                        <p class="mt-3 font-display text-2xl font-semibold tracking-tight text-white max-lg:text-center">Not enterprise theater.</p>
                        <p class="mt-3 max-w-lg text-sm/6 text-echo-400 max-lg:text-center">Real grades, real numbers, real next steps. Same Signal Score we'd run as part of an engagement &mdash; available free.</p>
                    </div>
                    {{-- Mock Signal Score result card --}}
                    <div class="relative flex-1 flex items-center justify-center px-8 pb-10 sm:px-10">
                        <div class="w-full max-w-sm rounded-xl bg-echo-950/80 p-6 ring-1 ring-echo-700/40 shadow-2xl shadow-crimson-950/50">
                            <p class="text-center text-xs font-mono uppercase tracking-widest text-echo-500">Signal Score</p>
                            <div class="mt-4 flex justify-center">
                                <div class="inline-flex items-center justify-center w-24 h-24 rounded-2xl border-4 border-yellow-400">
                                    <span class="font-display text-5xl font-bold text-yellow-400">C</span>
                                </div>
                            </div>
                            <p class="mt-4 text-center text-sm font-semibold text-white">Room to Grow</p>
                            <p class="mt-1 text-center text-xs text-echo-500">$300K–$750K annual risk exposure</p>
                            <div class="mt-6 space-y-2 border-t border-echo-800 pt-4">
                                @foreach([['Identity & Access', 'B', 'bg-blue-500'], ['Backup & Recovery', 'D', 'bg-orange-500'], ['Incident Readiness', 'F', 'bg-red-500']] as $row)
                                    <div class="flex items-center justify-between text-xs">
                                        <span class="text-echo-300">{{ $row[0] }}</span>
                                        <div class="flex items-center gap-2">
                                            <div class="h-1.5 w-16 rounded-full bg-echo-800 overflow-hidden">
                                                <div class="h-full {{ $row[2] }}" style="width: {{ $row[1] === 'B' ? 75 : ($row[1] === 'D' ? 35 : 15) }}%"></div>
                                            </div>
                                            <span class="font-mono font-bold text-white w-3">{{ $row[1] }}</span>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                ...
                <div class="pointer-events-none absolute inset-px rounded-lg outline outline-echo-700/40 max-lg:rounded-b-[2rem] lg:rounded-r-[2rem]"></div>
            </div>
