...
<section class="bg-echo-950 py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:auto-rows-fr">
            ...
            {{-- Vosburgh — featured (client voice, spans 2 cols on lg) --}}
            <figure class="relative isolate flex flex-col justify-between overflow-hidden rounded-2xl bg-gradient-to-br from-crimson-950/40 via-echo-900 to-echo-900 p-8 ring-1 ring-crimson-700/30 lg:col-span-2 lg:p-10">
                {{-- Decorative quote-mark accent --}}
                <svg viewBox="0 0 162 128" fill="none" aria-hidden="true"
                     class="absolute -top-2 right-6 -z-10 h-24 stroke-crimson-700/25">
                ...
                <div>
                    <span class="inline-flex items-center gap-1.5 rounded-full bg-crimson-900/50 px-2.5 py-1 text-xs font-mono uppercase tracking-wider text-crimson-300 ring-1 ring-crimson-700/30">
                        <span class="h-1.5 w-1.5 rounded-full bg-crimson-400"></span>
                        Client perspective
                    </span>
                    <blockquote class="mt-6 font-display text-2xl font-semibold leading-snug text-white sm:text-3xl">
                ...
                <figcaption class="mt-8 flex items-center gap-x-4 border-t border-echo-700/40 pt-6">
                    <div class="h-12 w-12 flex-none rounded-full bg-crimson-900/60 flex items-center justify-center ring-1 ring-crimson-700/40">
                        <span class="text-crimson-300 font-bold">JV</span>
                    </div>
                    <div>
                        <div class="font-semibold text-white">Jennifer Vosburgh</div>
                        <div class="text-sm text-echo-400">B2B Marketing Executive, Tego</div>
                    </div>
                </figcaption>
            </figure>

            {{-- Right column: Jackson + Sorensen stacked, smaller --}}
            <div class="flex flex-col gap-6">

                {{-- Jackson --}}
                <figure class="flex flex-1 flex-col justify-between rounded-2xl bg-echo-900/60 p-6 ring-1 ring-echo-700/40">
                    <blockquote class="text-sm leading-6 text-echo-200">
                        <p>&ldquo;Exceptional talent for building authentic, trust-based relationships. His skill set brings immediate value.&rdquo;</p>
                    </blockquote>
                    <figcaption class="mt-5 flex items-center gap-x-3 border-t border-echo-700/40 pt-4">
                        <div class="h-9 w-9 flex-none rounded-full bg-echo-800 flex items-center justify-center ring-1 ring-echo-700/40">
                            <span class="text-echo-300 font-bold text-xs">JJ</span>
                        </div>
                        <div class="min-w-0">
                            <div class="font-semibold text-white text-sm truncate">James L. Jackson</div>
                ...
                <figure class="flex flex-1 flex-col justify-between rounded-2xl bg-echo-900/60 p-6 ring-1 ring-echo-700/40">
                    ...
                    <figcaption class="mt-5 flex items-center gap-x-3 border-t border-echo-700/40 pt-4">
                        <div class="h-9 w-9 flex-none rounded-full bg-echo-800 flex items-center justify-center ring-1 ring-echo-700/40">
                            <span class="text-echo-300 font-bold text-xs">KS</span>
                        </div>
                        <div class="min-w-0">
                            <div class="font-semibold text-white text-sm truncate">Karan Sorensen</div>
