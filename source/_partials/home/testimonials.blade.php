    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-3xl text-center">
            <div class="flex items-center justify-center gap-3">
                ...
                <span class="font-mono text-xs uppercase tracking-widest text-crimson-450">What people say</span>
                <div class="w-8 h-1 bg-crimson-600 rounded-full"></div>
            </div>
            <h2 class="mt-6 font-display text-3xl font-bold tracking-tight text-balance text-white sm:text-4xl">
                What it's like to <span class="text-crimson-500">work with me.</span>
            </h2>
        </div>
        ...
        <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:auto-rows-fr">
            ...
            <figure class="relative isolate flex flex-col justify-between overflow-hidden rounded-2xl bg-echo-900/80 p-8 ring-1 ring-echo-700/50 transition-all hover:ring-echo-600">
                ...
                <figcaption class="mt-8 flex items-center gap-x-4 border-t border-echo-700/40 pt-6">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="text-xs text-echo-300">Cybersecurity Leader</div>
                    </div>
                </figcaption>
            </figure>
            ...
            <figure class="relative isolate flex flex-col justify-between overflow-hidden rounded-2xl bg-gradient-to-br from-crimson-950/30 via-echo-900/80 to-echo-900/80 p-8 ring-1 ring-crimson-700/30 transition-all hover:ring-crimson-600/50">
                ...
                <div>
                    <span class="inline-flex items-center gap-1.5 rounded-full bg-crimson-900/40 px-2.5 py-0.5 text-xs font-mono uppercase tracking-wider text-crimson-300 ring-1 ring-crimson-700/30">
                ...
                <figcaption class="mt-8 flex items-center gap-x-4 border-t border-echo-700/40 pt-6">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="text-xs text-echo-300">B2B Marketing Executive, Tego</div>
                    </div>
                </figcaption>
            </figure>
            ...
            <figure class="relative isolate flex flex-col justify-between overflow-hidden rounded-2xl bg-echo-900/80 p-8 ring-1 ring-echo-700/50 transition-all hover:ring-echo-600">
                ...
                <figcaption class="mt-8 flex items-center gap-x-4 border-t border-echo-700/40 pt-6">
                    ...
                    <div class="min-w-0">
                        ...
                        <div class="text-xs text-echo-300">Innovation &amp; Technology Executive</div>
                    </div>
                </figcaption>
            </figure>
