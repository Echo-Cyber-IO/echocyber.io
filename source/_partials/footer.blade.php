...
<footer class="bg-echo-900 border-t border-echo-800">
    <div class="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
            ...
            <a href="https://www.linkedin.com/in/mfaas/" target="_blank" rel="noopener noreferrer"
               ...
               aria-label="Connect on LinkedIn">
                <svg class="h-5 w-5 text-crimson-500 transition-colors group-hover:text-crimson-450" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div class="mt-12 pt-8 border-t border-echo-800">
            <p class="text-echo-300 text-sm text-center lg:text-left">
