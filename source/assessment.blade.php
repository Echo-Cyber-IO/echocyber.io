...
<div x-data="quiz()" x-cloak class="bg-hex-grid">
  ...
  <!-- HERO / LANDING                              -->
  <!-- ═══════════════════════════════════════════ -->
  <div x-show="step === 'landing'" x-transition class="min-h-screen flex flex-col">
    <!-- Hero -->
    <div class="flex-1 flex items-center justify-center px-6 py-12">
      <div class="max-w-3xl text-center">
        <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-crimson/10 border border-crimson/20 text-crimson-400 text-sm font-medium mb-8">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
          Free Security Assessment
        </div>

        <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight tracking-tight mb-6 font-display">
          How secure is your<br>
          <span class="text-crimson-500">business, really?</span>
        </h1>

        <p class="text-lg sm:text-xl text-echo-300 max-w-2xl mx-auto mb-4">
        ...
        <!-- What You Get -->
        <div class="mt-20 max-w-2xl mx-auto text-left">
          <h2 class="text-2xl font-bold mb-8 text-center font-display">What you'll walk away with</h2>
          <div class="space-y-4">
